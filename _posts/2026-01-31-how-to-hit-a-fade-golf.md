---
layout: post
title: "How to Hit a Fade in Golf: Master the Controlled Left-to-Right Shot"
date: 2026-01-31
categories:
- golf
- instruction
description: "Learn how to hit a fade shot in golf. Step-by-step guide covering grip, alignment, swing path, and drills for consistent left-to-right ball flight."
author: Swing Analyzer Team
image: /assets/images/how-to-hit-a-fade-golf.png
tags:
...
1. **Clubface angle** determines where the ball starts (about 75-85% of starting direction)
2. **Swing path relative to clubface** determines how much and which direction it curves
...
1. **Lead hand (left for righties)**: Rotate it counterclockwise until you see only 1.5-2 knuckles when looking down, instead of the typical 2-2.5
2. **Trail hand (right for righties)**: Position it more on top of the club, with the V between thumb and forefinger pointing toward your chin or lead shoulder
...
**Important**: Make small changes. A slightly weaker grip encourages a fade. An extremely weak grip creates slices. For a deeper understanding of how grip affects your ball flight, read our [golf grip guide](/blog/golf-grip-guide/).
...
1. **Aim your clubface** directly at your target
2. **Align your feet, hips, and shoulders** slightly left of target (for right-handers)
3. **This open stance** promotes the out-to-in swing path that creates fade spin
...
For detailed alignment fundamentals, including the intermediate target technique, see our [golf alignment and aim guide](/blog/golf-alignment-aim/).
...
For a deeper dive into controlling your clubface, see our [club face control guide](/blog/club-face-control/).
...
A fade built on poor fundamentals won't last. Make sure your [setup and stance](/blog/golf-setup-stance/) are solid before adding shot shaping. Trying to hit a fade with a flawed foundation creates compensations that break down under pressure.
...
**Week 1: Grip and Setup**
Focus entirely on the grip and stance changes. Hit half swings with a 7-iron, just getting comfortable with the new positions. Don't worry about ball flight yet.

**Week 2: Path Training**
Add the gate drill and alignment stick drill. Start connecting the setup to the swing path. You should see balls starting left and curving right, even if inconsistently.

**Week 3: Full Swings**
Graduate to full swings while maintaining the fundamentals. Film yourself to verify your path and face. Make adjustments based on what you see, not what you feel.

**Week 4: Course Integration**
Take your fade to the course. Start with low-pressure situations where a straight shot would also work. As confidence builds, use the fade in situations that demand it.
...
*Want to see exactly what your swing path and face angle are doing? [Swing Analyzer](https://swing.fulcria.com) traces your club through impact and shows you the data behind your ball flight. Get instant AI feedback in 90 seconds, no tripod required.*
