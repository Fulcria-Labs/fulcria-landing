---
layout: post
title: "How to Fix a Push Shot in Golf: Causes, Drills, and Fixes"
date: 2026-01-31
categories: [golf, instruction]
description: "Stop pushing golf shots right with proven fixes and drills. Learn the real causes of push shots and how to square your clubface for straighter iron and driver shots."
author: Swing Analyzer Team
image: /assets/images/how-to-fix-push-shot-golf.webp
tags:
- push shot
- push slice
- ball flight fix
...
**How to check**: At address, where is the ball relative to your stance? For mid-irons, it should be roughly center. For driver, inside your lead heel. Too far back is a common culprit. Our [ball position guide](/blog/golf-ball-position-guide/) covers proper placement for every club.
...
**How to check**: Set up to a shot, then lay a club along your toe line without moving. Step back and see where it points. If it aims at your target instead of left of it, your alignment is off. See our [alignment and aim guide](/blog/golf-alignment-aim/) for proper setup.
...
This simple change helps the face close more naturally through impact. For a complete breakdown, see our [golf grip guide](/blog/golf-grip-guide/).
...
If your ball curves after starting right, you have an open face issue on top of a path issue. Fix the face first by strengthening your grip and working on [club face control](/blog/club-face-control/). Then address the path.
...
Recording your swing with your phone takes thirty seconds and reveals what you cannot feel. For tips on capturing useful swing video, see our guide on [how to record your golf swing](/blog/phone-golf-swing-video/).
...
**Related Posts:**
- [How to Fix a Golf Slice](/blog/fix-golf-slice/) - The opposite miss pattern
- [How to Fix a Golf Hook](/blog/fix-golf-hook/) - When the ball curves too much left
- [Golf Grip Guide](/blog/golf-grip-guide/) - Proper hand position to square the face
- [Ball Position Guide](/blog/golf-ball-position-guide/) - Where to place the ball for every club
- [Club Face Control Guide](/blog/club-face-control/) - Mastering face angle at impact
- [Golf Alignment and Aim](/blog/golf-alignment-aim/) - How to set up square to your target

---

*Stop guessing why you push the ball. [Swing Analyzer](https://swing.fulcria.com) identifies your path and face angle in 90 seconds. Upload a swing and see exactly what is causing your miss, then get specific drills to fix it.*
